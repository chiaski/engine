...
//    console.log(XY);
  ...
  saveScene: function(){ // save active scene
    ...
    // save actions, if any
    $(".--directions[onMode='editor']  a[active]").each(function(i, a){
      let dir = $(a).attr("side");
  ...
  clearScene: function(){
    ...
    // actions
    $(".--directions a").removeAttr("active").attr("inactive", "");    
//    $("#engine-actions a span[text]").html("<span make>+</span>");
  ...
  loadScene: function(scene){
    ...
    // first, clear
    $(".--directions[onMode='editor'] a").removeAttr("active").attr("inactive", "");    
    $(".--directions[onMode='editor'] a span[text]").html("");
...
//          console.log((_active.actions)[a]);
          ...
          $(".--directions[onMode='editor']  a[side='" + (_active.actions)[a].dir +"']")
            .removeAttr("inactive").attr("active", "");

          $(".--directions[onMode='editor']  a[side='" + (_active.actions)[a].dir +"'] span[text]")
            .html(`<input type='text' value='` + (_active.actions)[a].text  + `'>`);
          
          if( $(".--directions[onMode='editor']  a[side='" + (_active.actions)[a].dir +"'] span[text] input[type='text']").length && $(".--directions[onMode='editor']  a[side='" + (_active.actions)[a].dir +"'] span[text] input[type='text']").val() == ""){
             $(".--directions[onMode='editor']  a[side='" + (_active.actions)[a].dir +"'] span[text] input[type='text']").attr("placeholder", "No text");
          }     
        }
    }
  },
...
$('document').ready(function(){
  ...
  $(".map span.s[x='" + originX + "'][y='" + originY +"']").attr("origin", "");
  
  // set click events
  
  $(".--directions div[onMode='editor']").on("click", "a[side]", function(){
       if ($(event.target).is('input[type="text"]')) {
            return; // Input field was clicked, return early
        }
  ...
  $(".--directions").on("click", "a[side]", function(){
     if ($(event.target).is('input[type="text"]')) {
          return; // Input field was clicked, return early
      }
